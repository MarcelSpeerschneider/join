...
function generateContactHTMLString(contact, i, color, firstLetterOfFirstName, firstLetterOfLastName) {
    return /*html*/ `
...
function generateContactInfo(contact, index, color, firstLetterOfFirstName, firstLetterOfLastName) {
    return /*html*/ `
...
<div style="display:none;" id="editPopUp" class="contact-pop-up">
    <div class="pup-up-content" action="">
        ...
        <div class="pop-up-right">
            <div onclick="closeEditWindow()" class="closeBtnEdit">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="close">
                        <mask id="mask0_83890_4117" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                            width="24" height="24">
