    ...
    <div class="contact-info">
        <div class="info-name">
          ...
          <div class="edit-delete-name">
            ...
            <div onclick="editContact(${index})" id="edit-contact"  class="edit-delete-Hover">
